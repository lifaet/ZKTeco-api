...
<div class="content">
    <div class="filters">
        ...
        <input type="month" id="filter-month" class="form-control d-none" value="<?php echo e(date('Y-m')); ?>">
...
<?php /**PATH /home/zim/zk/zkteco/resources/views/dashboard.blade.php ENDPATH**/ ?>